import postUsers from '../services/SignUp.jsx';
import readUsers from "../services/SignIn.jsx";
...
const Login = () => {
    ...
    const SendData = (e) => 
    {
        ...
        setEmailStatus(EmailValidator(Data.get("Email")));
        
        SignUp ? postUsers(Data, setSignUp): readUsers(Data, setUser);
    }
    return (
        <>
            <main className="flex min-h-screen items-center justify-center">
                <section className="relative flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
                    ...
                    {SignUp ? <p className="mt-1 block font-sans text-base font-normal leading-relaxed text-gray-700 antialiased">Enter your details to register.</p> : ""}
                    ...
                    <form id="Form" className="mt-8 mb-2 w-80 max-w-screen-lg mobile:w-full" onSubmit={(e) => SendData(e)} method="POST" noValidate>
                        ...
                        <p className="mt-4 block text-center font-sans text-base font-normal leading-relaxed text-gray-700 antialiased">
                            ...
                            <span className="ml-[10px] font-semibold text-[#ff6f7b] transition-colors hover:text-blue-700" onClick={() => setSignUp(oldValue => !oldValue)}>
                                {SignUp ? "Sign In" : "Sign Up"}</span>
                        </p>
                    </form>
                </section>
            </main>
